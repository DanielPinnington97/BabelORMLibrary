...
public abstract class BabelSystems {
        ...
        /*
        public static <T extends BabelUserDetails> List<BabelSQLResultsFilter> getAllAtDate(Date date, long rID) {
            return BabelStatementsSQL.construct().where(getAllAtDate(date, rID)).run(userState);
        }
        */
